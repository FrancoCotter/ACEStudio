...
export const translations = {
  en: {
    ...
    avatarFormats: 'JPG, PNG, WebP, GIF • Max 50MB • Keep the face centered and fully visible',
    bannerImage: 'Banner Image',
    clickToUploadBanner: 'Click to upload banner',
    bannerFormats: 'Recommended: 1500x500px • JPG, PNG, WebP, GIF • Max 50MB • If there is a face, keep the head and face near the upper-middle area',
    bio: 'Bio',
  ...
  zh: {
    ...
    avatarImage: '头像',
    uploadAvatar: '上传头像',
    avatarFormats: 'JPG、PNG、WebP、GIF • 最大 50MB • 建议让人脸位于中间并完整可见',
    bannerImage: '横幅图片',
    clickToUploadBanner: '点击上传横幅',
    bannerFormats: '推荐尺寸：1500x500px • JPG、PNG、WebP、GIF • 最大 50MB • 如果图片里有人脸，建议头部和脸放在偏上居中的区',
    bio: '个人简介',
  ...
  ja: {
    ...
    avatarFormats: 'JPG、PNG、WebP、GIF • 最大50MB • 顔が中央にあり、全体が見える画像を推奨',
    bannerImage: 'バナー画像',
    clickToUploadBanner: 'クリックしてバナーをアップロード',
    bannerFormats: '推奨サイズ：1500x500px • JPG、PNG、WebP、GIF • 最大50MB • 顔がある場合は、頭と顔をやや上寄り中央に配置してください',
    bio: '自己紹介',
    ...
    dcwSettings: 'DCW 設定',
    dcwDefaultOffHint: 'ノイズの多い生成を避けるため、Base モデルと SFT モデルでは DCW はデフォルトでオフになっています。',
    dcwWaveletBase: 'DCW ウェーブレットベース',
    dcwMode: 'DCW モード',
    dcwModeTooltip: 'DCW が強調する周波数帯域を選択します。Low は低周波構造、High は高周波ディテール、Double は両方、Pix はピクセルスタイルのウェーブレット動作、None は DCW モードを無効にします。',
    dcwModeLow: '低周波',
    dcwModeDouble: '両方',
    dcwModeHigh: '高周波',
    dcwModePix: 'Pix',
    dcwScaler: 'DCW スケーラー',
    dcwScalerTooltip: 'DCW 全体の強度です。値を大きくするとコンディショニングが強くなりますが、高すぎるとアーティファクトが発生したり、自然さが損なわれる場合があります。通常は小さめの値の方が安全です。',
    dcwHighScaler: 'DCW 高周波スケーラー',
    dcwHighScalerTooltip: '高周波 DCW ディテールに追加する強度です。値を大きくすると明るさやディテールが増しますが、高すぎると粗さやノイズ、不安定なテクスチャが発生することがあります。',
  ...
  ko: {
    ...
    avatarFormats: 'JPG, PNG, WebP, GIF • 최대 50MB • 얼굴이 중앙에 있고 온전히 보이는 이미지를 권장합니다',
    bannerImage: '배너 이미지',
    clickToUploadBanner: '클릭하여 배너 업로드',
    bannerFormats: '권장 크기: 1500x500px • JPG, PNG, WebP, GIF • 최대 50MB • 얼굴이 있다면 머리와 얼굴이 상단 중앙 부근에 오도록 권장합니다',
    bio: '자기소개',
    ...
    dcwSettings: 'DCW 설정',
    dcwDefaultOffHint: '노이즈가 많은 생성을 방지하기 위해 Base 및 SFT 모델에서는 DCW가 기본적으로 꺼져 있습니다.',
    dcwWaveletBase: 'DCW 웨이블릿 베이스',
    dcwMode: 'DCW 모드',
    dcwModeTooltip: 'DCW가 강조할 주파수 대역을 선택합니다. Low는 저주파 구조, High는 고주파 디테일, Double은 둘 다, Pix는 픽셀 스타일 웨이블릿 동작을 의미하며, None은 DCW 모드를 비활성화합니다.',
    dcwModeLow: '저주파',
    dcwModeDouble: '둘 다',
    dcwModeHigh: '고주파',
    dcwModePix: 'Pix',
    dcwScaler: 'DCW 스케일러',
    dcwScalerTooltip: 'DCW의 전체 강도입니다. 값을 높이면 컨디셔닝이 더 강해질 수 있지만, 너무 높으면 아티팩트가 발생하거나 자연스러움이 떨어질 수 있습니다. 일반적으로는 낮은 값이 더 안전합니다.',
    dcwHighScaler: 'DCW 고주파 스케일러',
    dcwHighScalerTooltip: '고주파 DCW 디테일에 추가로 적용되는 강도입니다. 값을 높이면 밝기와 디테일이 증가할 수 있지만, 너무 높으면 거친 느낌, 노이즈 또는 불안정한 텍스처가 생길 수 있습니다.',
